...
module.exports = (app, name) => {
  ...
  class ApiCustom {
    ...
    async post(data, type = 'msg') {
      ...
      switch (type) {
        case 'msg':
          url = app.config.wx[name].apiBaseUrl + app.config.wx[name].apiUrl.sendCustom + '?access_token=' + accessToken;
          break;
        case 'addCustomservice':
          url = app.config.wx[name].apiBaseUrl + app.config.wx[name].apiUrl.addCustomservice + '?access_token=' + accessToken;
          break;
    ...
    async getCustomserviceList() {
      ...
      const res = await app.curl(
        app.config.wx[name].apiBaseUrl + app.config.wx[name].apiUrl.getCustomserviceList,
        {
          data: {
